...
export default function HomePage() {
  ...
  return (
    <div className="w-full flex flex-col lg:grid lg:grid-cols-5 gap-2">
      <div className="col-span-3 w-full">
        ...
        <div className="bg-wild-sand-600 p-4">
          ...
          <span className="text-2xl text-gray-600 mr-2">{userInfo.email} </span>
        </div>
        <div className="bg-wild-sand p-4">
        ...
        <div className="bg-wild-sand-600 p-4">
          ...
          <span className="text-2xl text-gray-600 mr-2">
            {shippingAddress.telephone.slice(5)}***** {shippingAddress.cityCode}{" "}
          </span>
        </div>
      ...
      <div className="col-span-2 w-full">
        ...
        <div className="bg-wild-sand p-4">
          ...
          <span className="text-2xl text-gray-600 mr-2"> {shippingAddress.province} ، {shippingAddress.city} </span>
        </div>
        <div className="bg-wild-sand-600 p-4">
