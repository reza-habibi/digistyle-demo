import { TOrderState } from "../../type.ds";
import {
  ORDER_CREATE_FAIL,
...
export const orderDetailsReducer = (state = orderState, action: any) => {
  switch (action.type) {
...
export const orderDeleteReducer = (state:any = {}, action: { type: any; payload: any; }) => {
  switch (action.type) {
