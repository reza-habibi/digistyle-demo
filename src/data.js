...
export const Categories = [
    {
        ...
        subCategory: [
            ...
            },
            {
                ...
                image: "./images/product-category/category-personal-electrical-care.jpg"
            },
            {
                name: "عطر",
                nameEn: "perfume-all",
...
export const Comment = [
    {
        title: "عالی",
        author: "اصغر جوزجانی",
        description: "کیفیت خیلی خوبی داره و البته زیاد خنک نیست برا تابستون. من سایز لارج هستم ولی این تی شرت سایز مدیوم اندازه من هست. جنس لباس نخ پنبه کامل نیست و پلاسیک هم داخلش داره. ترکیب یخه خوب هست و با شستشو حالتش رو از دست نمی ده. فقط با تخفیف ویژه ارزش خرید داره"
    }, {
        title: "عالی",
        author: "اصغر جوزجانی",
        description: "کیفیت خیلی خوبی داره و البته زیاد خنک نیست برا تابستون. من سایز لارج هستم ولی این تی شرت سایز مدیوم اندازه من هست. جنس لباس نخ پنبه کامل نیست و پلاسیک هم داخلش داره. ترکیب یخه خوب هست و با شستشو حالتش رو از دست نمی ده. فقط با تخفیف ویژه ارزش خرید داره"
